...
def main():
    ...
    destination1x = [ -61.,-46., -80., -22.]

    destination1y = [ -98.,-55., -67., -91.]

    destination2x = [  95.,57.,  88.,  59.]

    destination2y = [   92.,52.,  39.,  27.]

    destinationx = [   43.,-84.,  34.,  95.]

    destinationy  = [ 53.,99.,  69.,  70.]        
        ...
        while not rospy.is_shutdown():
            ...
            if(((near_swarm1 == 1 and near_swarm2 == 1) or swarm_split == 1) and (eaten1 == 0 or eaten2 == 0)):
                ...
                if(entered_once == 0):
                    ...
                    initpoints,vels =  SheepMovement(initpoints,vels,Rrep,Rrep,Ratt,s1,dt,phi,omega,LeaderPos,rs,[],leaderRrep,leaderRori,leaderRatt,numpy.asarray([0,0]).reshape(1,2),0,0,[],numpy.asarray([0,0]).reshape(1,2),leader_idx)    
                    ...
                    ind_l1 = numpy.random.choice(numpy.size(ind_gcm1),2)
                    ind_l2 = numpy.random.choice(numpy.size(ind_gcm2),2)                    
                ...
                initpoints,vels =  SheepMovement(initpoints,vels,Rrep,Rrep,Ratt,s1,dt,phi,omega,LeaderPos,rs,[],leaderRrep,leaderRori,leaderRatt,numpy.asarray([0,0]).reshape(1,2),0,nol,[],numpy.asarray([0,0]).reshape(1,2),leader_idx)        
