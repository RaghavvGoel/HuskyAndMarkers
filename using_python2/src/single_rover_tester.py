...
def get_compass(msg):
    global heading_angle , flag4 , ini_angle
...
def main():
    ...
    rcompass = rospy.Subscriber('mavros/global_position/compass_hdg', Float64 , get_compass)
    ...
    while not rospy.is_shutdown():
        ...
        beta = (ini_angle - thetadeg)
        if(beta > 360):
            beta = beta%360
        elif(beta < 0):
            beta = beta%360 #SWEET CONVERSION : -40%360 = 320 :p    

            
        if(angle_to_publish > 180):
            angle_to_publish = angle_to_publish - 360
        print('angle_to_publish: ' , angle_to_publish)
        j = 0
        while(heading_angle < beta - 10 or heading_angle > beta + 10):
        #while(j < 1):
            #j = j + 1
            rov.coordinate_frame = 8
            rov.type_mask = 1991
            ...
            #ROTATATING IN ONE DIRECTION ONLY CURRENTLY
            #rov.yaw = 0.2
            
            #IMPROVING ON ROTATION:
            # if(thetadeg >= 0):
            #     yaw_to_publish = -0.2
            # else:
            #     yaw_to_publish = 0.2        
            ...
            #MORE IMPROVEMENT:
            # if(heading_angle - ini_angle >= 0):
            #     if(thetadeg >= 0):
            #         if(thetadeg <= heading_angle - ini_angle):                            
            #             yaw_to_publish = 0.2
            #         else:   
            #             yaw_to_publish = -0.2
            #     else:
            ...
            # if(heading_angle <= beta):
            #     #if(beta - heading_angle <= 180)
            #     yaw_to_publish = -0.2
            # else:
            #     yaw_to_publish = 0.2    
            ...
            rov.yaw_rate = yaw_to_publish

            print("heading: " , heading_angle , " beta: " , beta , " " , thetadeg , " " , ini_angle)
        ...
        # count3 = 0;
        # if(flag5 == 0):
        #     while((abs(heading_angle) > 5 or heading_angle == 0)):
        #         count3 = count3 + 1
        #         rov.coordinate_frame = 8
        #         rov.type_mask = 3015        
        #         rov.velocity.x = 0.5;
        ...
        #     while(rospy.get_rostime() < t1+rospy.Duration(3.0)):
        #           flag5 = 1  
        #     #print("COUNT3: " , count3)
        ...
        #     theta1 = theta
        #     #flag5 = 0
        # if(rospy.get_rostime() >= t1 + rospy.Duration(1.0)):
        #     #flag4 = 0
        #     theta2 = theta
        #     theta1 = theta 

        # if(abs(theta2 - theta1) > 160*(22.0/7)/180):
        #     theta = 0.0   
        # diff = 0
        # arr[0,p] = theta;
        # p = p+1;

        # diff = arr[0,0] - arr[0,9]

        # if(abs(diff) > 100*(22.0/7)/180):
        #     theta = 0.0
        #     if(p > 9):
        #         p = 0        
        #     arr[0,p] = 0.0
        ...
        #rover_angle = heading_angle - ini_angle
        #if rover>0&abs(thetadeg>90):

        # if(theta*(180)/(22.0/7) >= 0):
        #     th = theta*(180)/(22.0/7) 
        # else:   
                    
        # if(abs(rover_angle) > abs(thetadeg)  ):
        ...
        # if(abs(heading_angle - ini_angle) > abs(thetadeg) ):
        #     print("GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG")
        #     rov.yaw = 0.0
        #     ini_angle = heading_angle
        # else:
        #     if(abs(heading_angle - ini_angle) < abs(theta*(180)/(22.0/7)))        
        print("beta: " , beta)
        print("V: " , V , " thetadeg: ", thetadeg , " "  , "heading: ", heading_angle," " , ini_angle)    
        # if(theta > 10*(22/7.0)/180.0):
        #     theta = 10*(22/7.0)/180.0
        #     count2 = count2 + 1
        # elif(theta < -10*(22/7.0)/180.0):
        #     theta = -10*(22/7.0)/180.0    
        #     count2 = count2 + 1
        #rov.yaw = -0.2
        ...
        if(flag >= n):
            ...
            print("LAT and LON " , local_lat, " " , local_lon, " " , ini_local_lat , " " , ini_local_lon)
            break        
