...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if(toggle == 0):
            ...
            if(len(g1) > 0.1*(numpy.size(grp1)) and eaten1 == 0):
                print("GRP1")
                ...
                S0,mode1,I1 = sheperdMovement(Sh[0].reshape(1,2),initpoints[0][g1],initpoints[1][g1],ra,Pd,Pc,destination1,f,mindisShep,rhoash,alpha,ang,mode1,nin,ds,rs,method,predmasterslave,decrad,q,I1)
            else:
            ...
            if(len(g2) > 0.1*(numpy.size(grp2)) and eaten2 == 0):
                print("GRP2")
                sheepmovements(initpoints,((len(g2))),c,rs,Sh,ra,rhoa,rhos,unitvec,h,e,dps,mode2,destination2,p,swarm_split)
                S1,mode2,I2 = sheperdMovement(Sh[1].reshape(1,2),initpoints[0][g2],initpoints[1][g2],ra,Pd,Pc,destination2,f,mindisShep,rhoash,alpha,ang,mode2,nin,ds,rs,method,predmasterslave,decrad,q,I2)
            else:
                #out2 = 1;
                eaten2 = 1;
