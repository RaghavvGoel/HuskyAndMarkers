    ...
    for mc1 in range(MC):   
        ...
        for i1 in range(N+nos+nod): #to include shepherd too
            ...
            if(i1 >= N+nos):
                ...
                if(l == 0):
                    ...
                    marker.pose.position.y = -75
                    l = 1
                elif(l == 1):
                    marker.pose.position.x = 41
                    marker.pose.position.y = 75
                    l = 2 
                else:
                    marker.pose.position.x = 14
                    marker.pose.position.y = 25
                    #marker.color.r = 1.0
        ...
        while not rospy.is_shutdown():
            ...
            if(toggle == 0):
                ...
                if(out1 == 0 or out2 == 0):
                    ...
                    if(len(g2) >= 0.1*(numpy.size(grp2)) and eating2 == 0):
                        ...
                        f = pow(len(grp2),0.5)
                        Pd = ra*log(len(grp2))                    
                        Sh1,mode2,I2 = sheperdMovement(Sh[1].reshape(1,2),initpoints[0][g2],initpoints[1][g2],ra,Pd,Pc,destination2,f,mindisShep,rhoash,alpha,ang,mode2,nin,ds,rs,method,predmasterslave,decrad,q,I2)
                    else:
                        #out2 = 1;
                        eating2 = 1;
                ...
                if(out1 == 1 and out2 == 1 ): #and pos_update1 == 1 and pos_update2 == 1
                    ...
                    if(len(g2) > ceil(0.1*len(grp2)) and in2 == 0 and too_close == 0):#if too_close becomes 1, then in2 will become 1
                        ...
                        f = pow(len(grp2),0.5)
                        Pd = ra*log(len(grp2))                        
                        Sh1,mode2,I2 = sheperdMovement(Sh[1].reshape(1,2),initpoints[0][g2],initpoints[1][g2],ra,Pd,Pc,destination,f,mindisShep,rhoash,alpha,ang,mode2,nin,ds,rs,method,predmasterslave,decrad,q,I2)                      
                    else:    
                        in2 = 1;
            ...
            if(out1 == 0):
                ...
                if(M.markers[N1+nos].scale.x < 0.10):
                    #eating1 = 0;
                    out1 = 1;     
            ...
            if(out2 == 0):
                ...
                if(M.markers[N1+nos + 1].scale.x < 0.10):
                    #eating2 = 0;
                    out2 = 1;
