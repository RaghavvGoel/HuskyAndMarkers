...
def main():
    ...
    pub_marker = rospy.Publisher('multi_sheep_sheperd500', MarkerArray , queue_size=1)
   ...
   142.]
    ...
    for mc1 in range(MC):            
        ...
        for i1 in range(N+nos+nod): #to include shepherd too
            marker = Marker()
            #print("i1 " , i1)
            marker.header.frame_id = "/multi_sheep_sheperd500";
        ...
        while not rospy.is_shutdown():
            ...
            if(toggle == 0):
                sheepmovements(initpoints,n,c,rs,Sh,ra,rhoa,rhos,unitvec,h,e,dps,mode,destination,p,swarm_split,[1000,1000])
            else:
            ...
            if(Sh[0][1] <= Sh[1][1] and enter_once == 0):
                ...
                # Sh[nos-1][1] = 100;
                #rs = rs + 5;    
            temp_initpoints = numpy.copy(initpoints)    
