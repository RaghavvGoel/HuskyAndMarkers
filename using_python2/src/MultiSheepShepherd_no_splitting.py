   ...
   142.]
    ...
    #Shepherd=[-0,100]
        ...
        for i in range(N+nos+nod): #to include shepherd too
            marker = Marker()
            #print("i " , i)
            marker.header.frame_id = "/multi_sheep_sheperd_no200";
        ...
        while not rospy.is_shutdown():
            ...
            #     #print("sub_dest1: " , sub_dest1, " destination1 " , destination1)    
                ...
                Sh,mode,I = sheperdMovement(Sh,initpoints[0][outthreshold],initpoints[1][outthreshold],ra,Pd,Pc,destination1,f,mindisShep,rhoash,alpha,ang,mode,nin,ds,rs,method,predmasterslave,decrad,q,I)                
            # else:
