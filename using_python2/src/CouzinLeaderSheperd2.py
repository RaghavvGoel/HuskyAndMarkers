    ...
    while not rospy.is_shutdown():
        ...
        if(((near_swarm1 == 1 and near_swarm2 == 1) or swarm_split == 1) and (eaten1 == 0 or eaten2 == 0)):
            ...
            if(orient1 == 0 or orient2 == 0):
                ...
                initpoints,vels,notused,notused =  SheepMovement(initpoints,vels,Rrep,Rrep,Ratt,1.5*s1,dt,phi,omega,LeaderPos,rs,[],leaderRrep,leaderRori,leaderRatt,numpy.asarray([0,0]).reshape(1,2),0,0,[],numpy.asarray([0,0]).reshape(1,2))    
            ...
            initpoints,vels,notused,notused =  SheepMovement(initpoints,vels,Rrep,Rrep,Ratt,1.5*s1,dt,phi,omega,LeaderPos,rs,[],leaderRrep,leaderRori,leaderRatt,numpy.asarray([0,0]).reshape(1,2),0,nol,[],numpy.asarray([0,0]).reshape(1,2))        
