...
def main():
    ...
    rmove_sub_local1 = rospy.Subscriber('mavros/global_position/local', Odometry, get_position_local)
    #rvel = rospy.Publisher('mavros/setpoint_raw/local', PositionTarget, queue_size = 1)
    rvel1 = rospy.Publisher('mavros/setpoint_velocity/cmd_vel' , TwistStamped ,queue_size = 1)
    rcompass1 = rospy.Subscriber('mavros/global_position/compass_hdg', Float64 , get_compass)
    #global N
    #N = 100
    ...
    rs = 15/scalar  #radius of influence
    ...
    # D.action = Marker.ADD;
        if(i >= nos):
            ...
            marker.color.b = 1.0;
            marker.color.r = 0.0;
            marker.scale.x = threshold*2;
            marker.scale.y = threshold*2;
            marker.scale.z = 0.5; 
    ...
    while not rospy.is_shutdown():    
        ...
        # V1 =  sqrt(pow(dx,2) + pow(dy,2))
        # theta1 = numpy.arctan2(dy,dx)        
        ...
        #     rov1.twist.angular.z = speed_of_angular_change         
        #     rvel1.publish(rov1)
