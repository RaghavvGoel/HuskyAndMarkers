...
def main():
    ...
    rvel = rospy.Publisher('/mavros/setpoint_velocity/cmd_vel' , TwistStamped ,queue_size = 1)
    ...
    while not rospy.is_shutdown():    
        ...
        rov.twist.linear.x = V*10        
        rov.twist.angular.z = 0.0;
        ...
        while(heading_angle < beta - 10 or heading_angle > beta + 10):
            ...
            rov.twist.angular.z = yaw_to_publish
        ...
        print("beta: " , beta)
        print("V: " , V*5 , " thetadeg: ", thetadeg , " "  , "heading: ", heading_angle," " , ini_angle)    
